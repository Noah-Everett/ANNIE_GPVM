...
SOURCEFILEZIP=wcsim_03-02-19_ANNIEp2v6_nodigint.tar.gz
...
OUTDIR=/pnfs/annie/persistent/users/moflaher/wcsim/multipmt/tankonly/wcsim_03-02-19_ANNIEp2v6_nodigint_BNB_Water_10k_22-05-17
...
OUTFILE=wcsim_0.${THEFILENUM}.${INFILE_OFFSETFACTOR}.root
OUTLOG=wcsim_0.log
