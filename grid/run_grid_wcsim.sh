...
export W=${INPUT_TAR_DIR_LOCAL}/exp/annie/app/users/neverett/WCSim_Ar
export WB=${W}/build
export WS=${W}/WCSim

export HW=${HOMEDIR}/WCSim_Ar
export HB=${HW}/build
export HS=${HW}/WCSim
...
cd ${HB}
source ${HS}/setupenvsfnal > ${HOMEDIR}/WCSim_build_setup.log 2>&1
setup -f Linux64bit+3.10-2.17 gcc v4_9_3a
setup -f Linux64bit+3.10-2.17 g++ v4_9_3a
echo "which gcc"
which gcc
export CXX=$(which g++)
export CC=$(which gcc)
...
##########################################################
    ...
    Primary File Number: ${NUM}
         Primary Offset: ${OFFSET}
               Geometry: ${GEOMETRY}
 Number of WCSim Events: ${NWCSIM}
Number of g4dirt Events: ${NDIRT}
...
#################################################################
##################### WCSim_build_setup.log #####################
#################################################################
`cat ${HOMEDIR}/WCSim_build_setup.log`
